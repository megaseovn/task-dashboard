      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8 space-y-8">
        ...
        {toast && (
          <div className="fixed top-4 left-1/2 transform -translate-x-1/2 z-[9999] animate-bounce">
            <div className="bg-gradient-to-r from-yellow-300 via-pink-400 to-purple-500 text-white px-8 py-5 rounded-2xl shadow-2xl max-w-lg border-4 border-white transform transition-all duration-500 hover:scale-105">
              <div className="flex items-center gap-4 text-center justify-center">
                <span className="text-5xl animate-pulse">{toast.icon}</span>
                <p className="font-bold text-lg leading-snug drop-shadow-lg">{toast.text}</p>
