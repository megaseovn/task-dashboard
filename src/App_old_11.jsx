      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8 space-y-8">
        ...
        {toast && (
          <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-[9999] animate-bounce">
            <div className="bg-gradient-to-r from-yellow-300 via-pink-400 to-purple-500 text-white px-10 py-6 rounded-3xl shadow-2xl max-w-lg border-4 border-white transform transition-all duration-500 hover:scale-105">
              <div className="flex items-center gap-4 text-center justify-center">
                <span className="text-6xl animate-pulse">{toast.icon}</span>
                <p className="font-bold text-xl leading-snug drop-shadow-lg">{toast.text}</p>
