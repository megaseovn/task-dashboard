...
import { Plus, Edit2, Trash2, Send, Bell, LogOut, X, ExternalLink, AlertTriangle } from 'lucide-react';
                    ...
                    {status === 'Hoàn thành' && (
                      <div className="mb-2 space-y-1">
                        <div className="flex gap-1">
                          ...
                          />
                          <button onClick={() => handleSaveLink(task.id)} className="px-2 py-1 bg-blue-600 text-white rounded hover:bg-blue-700 text-xs">💾</button>
                        </div>
                        {task.link && (
                          <a href={task.link} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 text-blue-600 hover:text-blue-700 text-xs">
